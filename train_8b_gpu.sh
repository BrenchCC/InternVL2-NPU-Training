...
OUTPUT_DIR=/mnt/bn/brench-hl-volume2/internvl2_mllm_training/model_save_ckpts/InternVL2-8B-test-v1
...
torchrun \
  ...
  --use_thumbnail True \
  --ps_version 'v2' \
  --deepspeed "/opt/tiger/InternVL-Train/internvl_chat/zero_stage2_config.json" \
  --report_to "wandb" \
